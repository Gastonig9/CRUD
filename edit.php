...
if  (isset($_GET['id'])) {
  ...
  if(isset($_POST['update'])) {
    ...
    $_SESSION['message'] = "The task has been update successfully";
...
<div class="p-3 bg-info bg-opacity-10 border border-info border-start-0 rounded-end text-center fw-bold">Editar Tarea</div>
